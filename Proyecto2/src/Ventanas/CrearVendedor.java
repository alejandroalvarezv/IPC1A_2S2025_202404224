...
public class CrearVendedor extends javax.swing.JFrame {
    private final Administrador adminView;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CrearVendedor.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CrearVendedor().setVisible(true));
    }
